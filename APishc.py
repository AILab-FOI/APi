...
if __name__ == '__main__':
    parser = argparse.ArgumentParser( description='APi shell client: connect to any stdin/stdout/stderr listening/writing agent.')
    ...
    parser.add_argument( '--input', action="store_true", help="If provided input can be sent to agent. The other arguments (output, error) will be ignored." )
    parser.add_argument( '--output', action="store_true", help="If provided agent's output will be written to stdout. Argument error will be ignored. " )
    parser.add_argument( '--error', action="store_true", help="If provided agent's output will be written to stderr." )
